...
if __name__ == "__main__":
    ...
    for name, group in grouped_dataframe:
        ...
        table_data.append([name, num_rows, timeouts, round(average_runtime, 2), round(runtime_solved, 2), par_X])
    table_df = pd.DataFrame(table_data, columns=["Algorithm", "N", "#TO", "avgRT", "RTslv", "PAR"+ str(X_in_parX)])
